var app = angular.module("myApp", ['ngRoute','ui.bootstrap','slickCarousel']).config(['$locationProvider','$routeProvider', function($locationProvider,$routeProvider) {
   ...
   $routeProvider
   .when('/', {
      templateUrl: './home.html', controller: 'MainCtrl'
   }).when('/portfolio', {
      templateUrl: './page3.html', controller: 'PortfolioCtrl'
   }).when('/portfolio', {
      templateUrl: './page3.html', controller: 'MainCtrl'
   }).when('/portfolio-main', {
      templateUrl: './portfolio.html', controller: 'MainCtrl'
   }).when('/corporate', {
      templateUrl: './corporateMain.html', controller: 'MainCtrl'
   }).when('/header', {
